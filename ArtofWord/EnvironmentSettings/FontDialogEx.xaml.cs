...
using ArtOfWords.EnvironmentSettings; // Debug
...
namespace emanual.Wpf.Controls
{
    public partial class FontDialogEx : UserControl
    {
        ...
        private void lstFamilyName_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            ListedFont item = lstFamilyName.SelectedItem as ListedFont;
        ...
        private void UpdateFamilyName()
        {
            ...
            if (DlgLanguage == null)
            {
                foreach (FontFamily family in Fonts.SystemFontFamilies)
                {
                    ...
                    {
                        ListedFont item1 = new ListedFont();
            ...
            else // 特定の言語のとき
            {
                foreach (FontFamily family in Fonts.SystemFontFamilies)
                {
                    ...
                    ListedFont item2 = new ListedFont();
                    ...
                    if (dic2.ContainsKey(FXmlLanguage))
                    {
                        ...
                        if ((s != null) && (s.Length > 0))
                        {
                            ...
                            item2.SampleString = "AoWで快適な小説執筆環境を";
        ...
        //---------------------------------------------------------------------------------------------
        // 昇順ソートのためのコールバック関数
        private int SortComparison(ListedFont item1, ListedFont item2)
        {
