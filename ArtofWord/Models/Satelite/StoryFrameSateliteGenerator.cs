using ArtOfWords.ViewModels.Satelite.StoryFrameSatelite;
using ArtOfWords.Views.Satelite.StoryFrameSatelite;
...
namespace ArtOfWords.Models.Satelite.StoryFrameSatelite
{
